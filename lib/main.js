...
ApigeeTool.getcache = function(opts, cb) {
  var cmd = require('./commands/getcache');
  runCommand(cmd, opts, cb);
};

ApigeeTool.listcaches = function(opts, cb) {
  var cmd = require('./commands/listcaches');
  runCommand(cmd, opts, cb);
};

ApigeeTool.updatecache = function(opts, cb) {
  var cmd = require('./commands/updatecache');
  runCommand(cmd, opts, cb);
};
