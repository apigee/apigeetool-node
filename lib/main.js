...
ApigeeTool.createReference = function (opts, cb) {
  var cmd = require('./commands/createReference.js');
  runCommand(cmd, opts, cb);
};

ApigeeTool.getReferences = function (opts, cb) {
  var cmd = require('./commands/getReferences.js');
  runCommand(cmd, opts, cb);
};

ApigeeTool.updateReference = function (opts, cb) {
  var cmd = require('./commands/updateReference.js');
  runCommand(cmd, opts, cb);
};

ApigeeTool.deleteReference = function (opts, cb) {
  var cmd = require('./commands/deleteReference.js');
  runCommand(cmd, opts, cb);
};
