...
var Commands = {
  ...
  getcache: {
    description: 'Gets a Cache Resource in the environment',
    load: function() {
      return require('./getcache');
    }
  },
  listcaches: {
    description: 'List Cache Resources in the environment',
    load: function() {
      return require('./listcaches');
    }
  },
  updatecache: {
    description: 'Updates a Cache Resource in the environment',
    load: function() {
      return require('./updatecache');
    }
  },
  createProduct: {
