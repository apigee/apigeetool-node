...
var Commands = {
  ...
  createReference: {
    description: "Create a keystore or truststore reference",
    load: function () {
      return require('./createReference');
    }
  },
  getReferences: {
    description: "Gets all references in an Apigee environment or retrieves a specific reference",
    load: function () {
      return require('./getReferences');
    }
  },
  updateReference: {
    description: "Updates a reference",
    load: function () {
      return require('./updateReference');
    }
  },
  deleteReference: {
    description: "Deletes a reference",
    load: function () {
      return require('./deleteReference');
    }
  } 
};
