...
ApigeeTool.createReference = function(opts) {
  var cb = q.defer()
  var cmd = require('./commands/createReference');
  runCommand(cmd, opts, cb);
  return cb.promise
}
ApigeeTool.getReferences = function(opts) {
  var cb = q.defer()
  var cmd = require('./commands/getReferences');
  runCommand(cmd, opts, cb);
  return cb.promise
}
ApigeeTool.updateReference = function(opts) {
  var cb = q.defer()
  var cmd = require('./commands/updateReference');
  runCommand(cmd, opts, cb);
  return cb.promise
}
ApigeeTool.deleteReference = function(opts) {
  var cb = q.defer()
  var cmd = require('./commands/deleteReference');
  runCommand(cmd, opts, cb);
  return cb.promise
}
